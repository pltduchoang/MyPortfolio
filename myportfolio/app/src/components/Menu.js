...
export default function Menu() {
    ...
    return (
        <div className='w-full'>
            ...
            <div ref={menuRef} className={`transition-all w-full duration-700 ease-in-out fixed left-0 element flex justify-between px-6 h-16 ${isNightMode? 'menu-bg-night':'menu-bg-day' }  ${isTop ? '-translate-y-16' : ''} ${isFilterVisible ? '' : '-translate-y-16'} lg:opacity-0 `}>
