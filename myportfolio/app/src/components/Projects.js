...
export default function Projects (){
    ...
    style={scaleUp? scaleUpStyle :{}}>
        ...
        <div className={`relative project-section my-4 transition-all duration-500 ease-in-out hover:opacity-85 opacity-75 `}>
        ...
        <div className={`relative project-section my-4 transition-all duration-500 ease-in-out hover:opacity-85 opacity-75 ${pushDownThree? 'push-down' : ''} `}
