...
const ProjectShowcase = ({
  ...
  return (
    <div
      className={`relative project-section my-4 transition-all duration-500 ease-in-out hover:opacity-100 opacity-90 `}
    >
      <div
        className={`px-10 pt-10 relative ${
          isNightMode ? "bg-stone-900" : "bg-slate-200"
        }`}
      >
        <div
          className={``}
        ...
        >
          ...
          <div className="flex flex-wrap">
            {project.techStack.map((item, index) => (
              <div
                key={index}
                className={`rounded-full px-1 mr-1 mt-1 opacity-70 ${
                  isNightMode ? "tag-night" : "tag-day"
                }`}
              >
      ...
      <div
        className={`absolute top-0 left-0px-10 w-full pb-10 ${
          isNightMode ? " bg-stone-900" : "bg-slate-200"
        } flex flex-col justify-center items-center transition-all duration-500 ease-in-out ${
          project.id === expand ? "opacity-100" : "opacity-0"
        }`}
        style={{
          zIndex: -1,
          ...(project.id === expand ? pushDownThumbnailStyle : { opacity: 0 }),
          ...(raiseButton ? { zIndex: 0 } : { zIndex: -1 }),
        }}
        ref={demoRef}
      >
        {children}
...
export default function Projects({ handleToggleModal }) {
  ...
  const projectList = [
    {
      ...
      description:
        "A management system for small and medium non-profit organization",
      techStack: ["Next.js", "TailwindCSS", "Firebase", "OAuth"],
      features: [
        "Manage members, volunteers, and events",
        "Mange event's attendees and volunteers",
        "Schedule volunteers",
      ],
    },
    {
      ...
      role: "Full stack developer",
      description:
        "Tracking everyday's expense, designed for personal and small business, providing a financial insight.",
      techStack: ["React", "React Native", "Firebase", "Android"],
      features: [
        "Expense record, visual insight with charts",
        "Instant sync with online database",
        "Categories, accounts, savings, budget",
        "10 years expense to assist tax filing, auditing",
      ],
    },
    {
      id: 3,
      ...
      role: "Full stack developer",
      description:
        "Management system for Grow within Nutrition. A small business in Calgary.",
      techStack: ["Next.js", "TailwindCSS", "React", "MySQL", "JS"],
      features: [
        "Manage users",
        "Selling services",
        "Schedule session and assign staffs",
        "Display information and advertising",
      ],
    },
    {
      id: 4,
      ...
      role: "Full stack developer",
      description:
        "Web application for Premium Artificial Lifts, a small business in Calgary",
      techStack: ["React", "Firebase", "Android", "Next-auth", "OAuth"],
      features: [
        "Enhance visual recognition",
        "Responsive display",
        "Authentication",
        "Upload, host and download file",
      ],
    },
  ];
  ...
  return (
    <div
      className={`font-normal text-base pt-2 pb-10 ${
        isNightMode ? "text-night-light" : "text-day-light"
      }  px-6 lg:pl-10 lg:pr-14}`}
    >
      <h2
            ...
            {project.id === 1 && (
              <div className="w-full">
                  ...
                  <div className="flex flex-row justify-around thumbnail">
                    <div className="relative w-8/12 p-4">
                      ...
                      <div className="laptop-video p-3">
                        <video
                          className=""
                          src="/project/ngo/NGOVideoDemo2.mp4"
                          autoPlay
                          loop
                          muted
                        />
                ...
                <div className="flex flex-row w-full mt-2 justify-around">
                  ...
                  >
                    <div
                      className={`px-3 py-2 hover:scale-105 transition duration-200 ease-in-out ${
                        isNightMode ? "tag-night" : "tag-day"
                      }`}
                    >
                      Github
            ...
            {project.id === 3 && (
              <div className="w-full">
                <div className=" justify-around thumbnail">
                  <div
                    className="w-full px-10 hover:cursor-pointer"
                    onClick={handleToggleModal}
                  >
                    <img
                      className="w-full rounded-lg shadow-lg"
                      src="/project/gwn-video.png"
                      alt="Grow Within Nutrition"
                    />
                  </div>
                </div>
